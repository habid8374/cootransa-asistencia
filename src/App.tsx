...
// Tiquetes desactivados temporalmente
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Tiquetes desactivados — redirigen al admin hasta nueva orden */}
        <Route path="/tiquetes/*" element={<Navigate to="/admin" replace />} />
        <Route path="/conductor" element={<Navigate to="/admin" replace />} />
        <Route path="*" element={<Navigate to="/admin" replace />} />
      </Routes>
    </BrowserRouter>
  )
